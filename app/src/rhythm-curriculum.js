...
export const CURRICULUM_UNITS = [
  {
    ...
    bpm: 80,
    meter: '4/4',
    learn: '4/4 한 마디의 기본박은 ♩ 네 번입니다. 8분음표 ♪는 기본박 하나의 절반이에요. 메트로놈을 켜 두고 음표가 있는 순간에 TAP한 다음, 같은 리듬을 따라 쳐 보세요.',
    lecturePoints: [
      '한 마디 = 기본박 ♩ 네 번',
      '♪ 8분음표는 기본박의 절반',
      '음이 있는 순간에만 TAP · 그다음 똑같이 따라 치기',
    ],
  },
  {
    id: 'u2-8mix',
    ...
    bpm: 80,
    meter: '4/4',
    learn: '같은 음표라도 놓는 위치가 바뀌면 느낌이 달라집니다. 기본박을 세며 어느 박에 음이 오는지 귀와 손으로 맞춰 보세요.',
    lecturePoints: [
      '♩♪♪ 과 ♪♪♩ 는 음표는 같아도 위치가 다릅니다',
      '기본박을 세며 ‘몇 번째 박에 음이 오나’를 듣습니다',
      '같이 친 뒤, 악보 없이 기억해서 따라 칩니다',
    ],
  },
  {
    id: 'u3-rests',
    ...
    bpm: 80,
    meter: '4/4',
    learn: '쉼표도 리듬입니다. 손이 멈추는 순간에도 기본박은 머릿속에서 계속 가야 해요. 쉬는 칸에서는 TAP하지 마세요.',
    lecturePoints: [
      '쉼표는 침묵이지, 박이 사라지는 것이 아닙니다',
      '쉬는 칸에서는 TAP하지 않습니다',
      '머릿속 기본박이 끊기지 않게 유지합니다',
    ],
  },
  {
    id: 'u4-sync',
    ...
    bpm: 88,
    meter: '4/4',
    learn: '싱코페이션은 예상한 박보다 앞당기거나 밀어 치는 리듬입니다. 기본박을 놓치지 않은 채 음표만 어긋나게 TAP해 보세요.',
    lecturePoints: [
      '기본박은 그대로, 손만 앞당기거나 밀어 칩니다',
      '점4분+8분은 첫 음을 길게 가져간 뒤 짧은 음이 따라옵니다',
      '흔들려도 메트로놈 클릭을 기준으로 돌아옵니다',
    ],
  },
  {
    id: 'u5-68',
    ...
    bpm: 96,
    meter: '6/8',
    learn: '6/8의 기본박은 점4분음표 두 번(복박)입니다. 한 묶음이 8분음표 3개예요. ♩. 두 번을 느끼며 그 안에 음표를 나눠 칩니다.',
    lecturePoints: [
      '6/8 기본박 = 점4분음표 두 번',
      '한 묶음 안에 8분음표가 3개입니다',
      '둘로 크게 흔들며 그 안을 나눠 TAP합니다',
    ],
  },
  {
    id: 'u6-2bar',
    ...
    bpm: 100,
    meter: '4/4',
    learn: '두 마디를 한 호흡으로 읽습니다. 1마디가 끝나도 기본박을 끊지 말고, 다음 마디 첫 음까지 박을 이어 가세요.',
    lecturePoints: [
      '1마디가 끝나도 기본박을 끊지 않습니다',
      '두 마디를 한 호흡으로 읽고 칩니다',
      '다음 마디 첫 음까지 박을 이어 갑니다',
    ],
  },
  {
    id: 'u7-jazz',
    ...
    bpm: 100,
    meter: '4/4',
    learn: '재즈 느낌은 기본박을 단단히 둔 채 뒷박·쉬는 박을 살리는 데서 납니다. 메트로놈은 켜 두고, 손만 그루브에 태워 보세요.',
    lecturePoints: [
      '기본박은 고정, 손만 뒷박·쉼에 태웁니다',
      '메트로놈을 끄지 않은 채 그루브를 연습합니다',
      '쉬는 박과 들어오는 박의 대비를 듣습니다',
    ],
  },
  {
    id: 'u8-sixteenth',
    ...
    bpm: 72,
    meter: '4/4',
    learn: '16분음표는 기본박 하나를 넷으로 나눕니다. BPM을 낮추고, 기본박 클릭 사이에 손이 몇 번 가는지 세며 연습하세요.',
    lecturePoints: [
      '기본박 하나 = 16분음표 네 개',
      '먼저 BPM을 낮춰 칸을 세며 칩니다',
      '클릭과 클릭 사이에 손이 몇 번 가는지 확인합니다',
    ],
  },
];
