...
export const GIRYONG_LINES = {
  welcome: [
    '안녕! 나 기룡이야. 오늘 강의부터 같이 볼까?',
    '매일 개념을 읽고, 메트로놈으로 손이 따라오면 리듬감이 생겨!',
    '게임은 복습이야. 먼저 오늘 단원을 강의처럼 익혀보자!',
  ],
  checkIn: [
    '출석 완료! 이제 오늘의 강의를 읽고 연습하자!',
    '도장 찍었어. 개념 읽고 메트로놈으로 따라 치는 게 오늘의 핵심이야!',
    '꾸준함이 최고의 연습이야. 강의 → 연습 → 확인 순서로 가보자!',
  ],
